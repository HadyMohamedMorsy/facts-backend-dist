...
exports.ConsultancyController = void 0;
...
let ConsultancyController = class ConsultancyController extends base_controller_1.BaseController {
    constructor(consultancyService, TransformRequest) {
...
exports.ConsultancyController = ConsultancyController;
__decorate([
    (0, common_1.Get)(":slug"),
...
], ConsultancyController.prototype, "findBySlug", null);
exports.ConsultancyController = ConsultancyController = __decorate([
    (0, common_1.Controller)("consultancy"),
    __metadata("design:paramtypes", [consultancy_service_1.ConsultancyService,
        transform_request_entity_provider_1.TransformRequest])
], ConsultancyController);
//# sourceMappingURL=consultancy.controller.js.map