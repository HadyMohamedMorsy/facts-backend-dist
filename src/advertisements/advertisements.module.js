...
exports.AdvertisementsModule = AdvertisementsModule = __decorate([
    (0, common_1.Module)({
        imports: [users_module_1.UsersModule, filter_date_module_1.FilterDateModule, typeorm_1.TypeOrmModule.forFeature([advertisement_entity_1.Advertisement])],
        controllers: [advertisement_controller_1.AdvertisementServiceController],
