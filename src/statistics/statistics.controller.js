...
const statistics_service_1 = require("./providers/statistics.service");
let StatisticsController = class StatisticsController extends base_controller_1.BaseController {
    constructor(statisticsService, TransformRequest) {
